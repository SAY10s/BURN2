    ...
    <Modal>
      ...
      <div className="text-primary grid grid-cols-2 gap-x-6 gap-y-4 text-base">
        <div className="col-span-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-secondary">
              + ({attackData.offensiveStat} cecha + {attackData.offensiveSkill}{" "}
              zdol. + {attackData.offensiveModifier} mod.) ={" "}
          ...
          <div className="mt-2 flex items-center gap-2">
            <label className="text-primary font-bold">Modyfikator ataku:</label>
            <input
              type="number"
        ...
        <div className="col-span-2 mt-2 flex items-center">
          ...
          />
          <label htmlFor="isTargetHit" className="text-primary ml-2 font-bold">
            Cel został trafiony
          </label>
        </div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    const newStatuses = e.target.checked
                      ...
                      : attackData.appliedStatuses.filter((s) => s !== status);
                    setAttackData({
                      ...attackData,
